...
It works for basic courses, not for courses with lab/recitation/extra days. I might work on implementing that next and optimizing the code because I took some very naive approaches.
